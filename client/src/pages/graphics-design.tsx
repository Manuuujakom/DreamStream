      ...
      <div className="py-20 px-6 min-h-screen">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-6xl font-bold text-[#F8F8F8] mb-6">Graphics & Design</h1>
            <p className="text-xl text-[#CCD2E3] max-w-3xl mx-auto leading-relaxed">
              Professional visual solutions that capture your brand's essence and communicate your message effectively.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#0A1128] border border-[#C9B072] rounded-xl p-6 text-center service-card">
              <Image className="w-16 h-16 text-[#C9B072] mx-auto mb-4" />
              <h3 className="text-xl font-bold text-[#F8F8F8] mb-3">Logo Design</h3>
              <p className="text-[#CCD2E3]">Memorable logos that represent your brand identity</p>
            </div>
            <div className="bg-[#0A1128] border border-[#C9B072] rounded-xl p-6 text-center service-card">
              <Layout className="w-16 h-16 text-[#C9B072] mx-auto mb-4" />
              <h3 className="text-xl font-bold text-[#F8F8F8] mb-3">Poster Design</h3>
              <p className="text-[#CCD2E3]">Eye-catching posters for events and marketing</p>
            </div>
            <div className="bg-[#0A1128] border border-[#C9B072] rounded-xl p-6 text-center service-card">
              <Video className="w-16 h-16 text-[#C9B072] mx-auto mb-4" />
              <h3 className="text-xl font-bold text-[#F8F8F8] mb-3">Video Editing</h3>
              <p className="text-[#CCD2E3]">Professional video editing and motion graphics</p>
            </div>
          </div>

          {/* Portfolio Gallery */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-[#F8F8F8] mb-8 text-center">Our Portfolio</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <img 
                ...
                alt="Corporate Design Portfolio" 
                className="rounded-lg shadow-lg hover:shadow-xl transition duration-300" 
              />
              <img 
                src="https://images.unsplash.com/photo-1541701494587-cb58502866ab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600" 
                alt="Creative Design Process" 
                className="rounded-lg shadow-lg hover:shadow-xl transition duration-300" 
              />
              <img 
                src="https://images.unsplash.com/photo-1634942537034-2531766767d1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600" 
